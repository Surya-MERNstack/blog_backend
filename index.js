...
// CORS options
const corsOptions = { 
  origin: ['https://blogworkspace.netlify.app', "http://localhost:5173", "*"],
  credentials: true,
};
...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'http://localhost:5173', "*","https://blogworkspace.netlify.app" );
